...
# add in error handling for when there is a timeout

###########################################
####  Grabbing and Splitting the Data  ####
###########################################
# grab the MNIST data
...
# predict for 1 obs
singlePrediction = logisticRegr.predict(test_img[0].reshape(1, -1))
print(singlePrediction)

# predict multiple
multPredictions = logisticRegr.predict(test_img[0:10])
